...
const GENERATED_NON_TERMINAL_CHARACTERS = `${process.cwd()}/spec/system/non-terminal-characters.txt`;
const GENERATED_TERMINAL_CHARACTERS = `${process.cwd()}/spec/system/terminal-characters.txt`;
const GENERATED_PARSER_FUNCTIONS = `${process.cwd()}/spec/system/parser-functions.rs.txt`;
